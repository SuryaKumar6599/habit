        ...
        <div className="flex items-start gap-4 relative z-10">
          ...
          <div>
            ...
            <p className="text-xs text-text-secondary mb-3 leading-relaxed">
              Allow the crow to remind you at 8am for daily bounties and 6pm before your streak is at risk.
            </p>
            <div className="flex gap-2">
              <button
                onClick={() => handleResponse(true)}
                disabled={enabling}
                className="px-4 py-1.5 rounded-lg bg-purple-500 hover:bg-purple-400 text-white text-xs font-bold transition-colors disabled:opacity-60"
              >
                {enabling ? 'Arming...' : 'Allow'}
              </button>
              <button
                onClick={() => handleResponse(false)}
